...
public class ProfilePicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_profile_pic, parent, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        // Saves profile pic
        btnMakeProfPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void setProfilePic(File photoFile, ParseUser currentUser) {
        ...
        currentUser.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null) {
                    Log.e(TAG, "Error while saving profile pic", e);
